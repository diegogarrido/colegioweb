...
public class Proyecto1PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Proyecto1";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Proyecto1PersistentManager();
		}
